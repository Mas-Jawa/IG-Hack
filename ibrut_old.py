...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def AppUac(self, GoblokLu=None):
       ...
       self.dvc = random.choice(["27/9","27/10","27/11","27/12","27/12","27/13","28/9","28/10","28/11","28/12","28/12","28/13","29/9","29/10","29/11","29/12","29/12","29/13","27/9","30/10","30/11","30/12","30/12","30/13","31/9","31/10","31/11","31/12","31/12","31/13","32/9","32/10","32/11","32/12","32/12","32/13","33/9","33/10","33/11","33/12","33/12","33/13"])
       ...
       bsa = random.choice(['ru_RU','en_GB','uk_UA','en_US','de_DE','it_IT','ru_UA','ar_AE','tr_TR','lv_LV','th_TH','fr_FR','sr_RS','hu_HU','bg_BG','pt_PT','pt_BR','es_ES','en_IE','nl_NL','fr_CH','de_CH','es_US','fr_CA','ru_BY','en_PH','en_AU','hy_AM','fa_IR','de_AT','cs_CZ','ru_KZ','en_CA','fr_BE','az_AZ','en_NZ','en_ZA','es_LA','ru_KG','pl_PL','es_MX','ro_RO','el_GR','iw_IL','in_ID','ga_IE','en_IN','ar_SA','ka_GE','es_CO','es_SV','hr_HR','ar_JO','es_PE','it_SM','ar_AR','en_SE','nb_NO','sk_SK','bs_BA','nl_BE','uz_UZ','sl_SI','es_CL'])
       gmut = random.choice(["wide","normal"])
       verscale = random.choice(["3.00","2.00"])
       self.uaa8 = f'Barcelona {self.di_versi_ig} (iPhone{random.randint(5,18)},{random.randint(0,8)}; iOS {random.randint(5,18)}_{random.randint(0,8)}; self.{bsa}; {bsa}; scale=2.{random.randint(10,80)}; gamut={gmut}; {self.pxl} {self.kode})'
       self.uaa9 = f'Barcelona {self.di_versi_ig} (iPhone{random.randint(5,18)},{random.randint(0,8)}; iOS {random.randint(5,18)}_{random.randint(0,8)}; self.{bsa}; {bsa}; scale={verscale}; gamut={gmut}; {self.pxl} {self.kode})'
       self.uaa10 = f'Instagram {random.randint(20,450)}.0.0.{random.randint(10,90)}.{random.randint(10,500)} (iPhone{random.randint(5,18)},{random.randint(0,9)}; iOS {random.randint(5,15)}_{random.randint(0,8)}_{random.randint(0,8)}; {bsa}; {bsa}; scale={verscale}; gamut={gmut}; {self.pxl})'
       self.uaa11 = f'Instagram {random.randint(20,450)}.0.0.{random.randint(10,90)}.{random.randint(10,500)} (iPhone{random.randint(5,18)},{random.randint(0,9)}; iOS {random.randint(5,15)}_{random.randint(0,8)}; {bsa}; {bsa}; scale={verscale}; gamut={gmut}; {self.pxl})'
       return(random.choice([self.uaa8, self.uaa9, self.uaa10, self.uaa11]))
